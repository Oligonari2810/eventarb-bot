...
class TriageAndPR:
    def __init__(self):
        ...
        self.FORBIDDEN_PATTERNS = [
            ".env", "secrets", "ENV", "KILL_SWITCH", 
            "API_KEY", "SECRET", "TOKEN", "PASSWORD",
            "credentials", "private_key", "ssh_key"
        ]
    ...
    def _scan_recent_logs(self) -> List[Dict[str, Any]]:
        ...
        for log_file in log_dir.glob("app_*.log"):
            try:
                ...
                error_patterns = [
                    "ERROR:", "Exception:", "Traceback:", "Fatal error:",
                    ...
                    if pattern in content:
                        ...
                        if error_lines:
                            errors.append({
                                ...
                                'context': content[:500]  # Primeros 500 caracteres como contexto
                            })
                        break
    ...
    def _security_check(self, analysis: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            for file_path in files_to_modify:
                ...
                if not any(file_path.endswith(ext) for ext in self.ALLOWED_FILE_EXTENSIONS):
                    print(f"Archivo prohibido por extensión: {file_path}")
                    return False
                
                # Verificar patrones prohibidos
                if any(pattern in file_path.lower() for pattern in self.FORBIDDEN_PATTERNS):
    ...
    def _create_pull_request(self, error: Dict[str, Any], analysis: Dict[str, Any], fix_code: str) -> bool:
    ...
    def _generate_pr_body(self, error: Dict[str, Any], analysis: Dict[str, Any], fix_code: str) -> str:
