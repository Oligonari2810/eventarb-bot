#!/usr/bin/env python3
"""
Script de validación rápida (5 minutos) para EventArb Bot
Versión corta para testing antes de validación de 24h
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('logs/validation_5min.log'),
        logging.StreamHandler()
    ]
)
logger = logging.getLogger(__name__)

class Validation5min:
    def __init__(self, db_path="events.db"):
        self.db_path = db_path
        self.start_time = datetime.utcnow()
        self.validation_duration = timedelta(minutes=5)  # Solo 5 minutos
    ...
    def check_heartbeat(self):
        ...
        # Log métricas cada 2 heartbeats
        if self.metrics['heartbeats'] % 2 == 0:
    ...
    def check_alerts(self):
        ...
        try:
            ...
            if alert_log_file.exists():
                ...
                logger.info("ℹ️ Archivo de log no encontrado (normal en test inicial)")
    ...
    def start_validation(self):
        """Inicia la validación de 5 minutos"""
        logger.info("🎯 INICIANDO VALIDACIÓN RÁPIDA (5 MINUTOS)")
        logger.info("=" * 50)
        ...
        try:
            while self.running:
                ...
                # Verificar si hemos completado 5 minutos
                if elapsed >= self.validation_duration:
                    logger.info("🎉 VALIDACIÓN DE 5 MINUTOS COMPLETADA")
                    break
    ...
    def generate_final_report(self):
        ...
        logger.info("📊 REPORTE FINAL DE VALIDACIÓN RÁPIDA")
        logger.info("=" * 50)
        logger.info(f"⏰ Inicio: {self.start_time.isoformat()}")
        ...
        logger.info("💡 Si todo está OK, puedes ejecutar la validación de 24h completa")

def main():
    """Función principal"""
    print("🎯 EVENTARB BOT - VALIDACIÓN RÁPIDA (5 MINUTOS)")
    print("=" * 50)
