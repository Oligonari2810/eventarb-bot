...
class LogSentry:
    def __init__(self):
        ...
        self.error_patterns = [
            ...
            "OSError:", "RuntimeError:", "SystemError:"
        ]
        self.critical_patterns = [
            "Fatal Python error", "OSError: [Errno 9]", "Bad file descriptor",
            "can't initialize sys standard streams", "KILL_SWITCH=1"
        ]
    ...
    def _record_error(self, pattern: str, file_path: str, content: str):
        ...
        # Log del error
        print(f"⚠️ Error detectado: {pattern} en {file_path} (count: {self.error_counts[key]})")
