...
def check_base64_service_account():
    ...
    try:
        ...
        assert "client_email" in info and "private_key" in info, "Campos clave faltan en JSON"
...
def main():
    ...
    try:
        ...
        if acts:
            a = acts[0]
            print(f"   → {a.symbol} {a.side} notional=${a.notional_usd} TP={a.tp_pct}% SL={a.sl_pct}% timing={a.timing}")
