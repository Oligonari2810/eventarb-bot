    ...
    try:
        ...
        for i, row in enumerate(rows, start=2):
            if len(row) >= 7:
                ...
                is_trade = any(keyword in row_text for keyword in 
        ...
        if valid_events:
            ...
            # Agregar headers
            headers = ["id", "kind", "t0_iso", "symbols_csv", "consensus", "note", "enabled"]
        ...
        if trade_orders:
            ...
            # Headers para trades
            trade_headers = ["id", "symbol", "side", "quantity", "entry_price", "tp_price", "sl_price", "risk_pct", "enabled", "created_at", "closed_at", "pnl_usd"]
